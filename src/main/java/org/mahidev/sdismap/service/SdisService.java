...
public record SdisService(SdisRepository repository, SdisCommonRepository commonRepository,
                          SdisDetailsRepository detailsRepository)
    ...
    @Override
    public Optional<SdisCommon> getSdisCommon(@NonNull final String siteLatitude,
                                              @NonNull final String siteLongitude,
